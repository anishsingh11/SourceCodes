...
public class EmployeeViewAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnNgoList, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 251, -1));
        ...
        add(btnRaiseIssue, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 251, -1));
        ...
        add(btnProjects, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 250, -1));
        ...
        add(btnHelpline, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, 251, -1));

        btnViewChart.setText("View Issue Statistics");
        btnViewChart.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnViewChartActionPerformed(evt);
            }
        });
        add(btnViewChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 390, 251, -1));
    ...
    private void btnProjectsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProjectsActionPerformed
        // TODO add your handling code here:
        CardLayout  cardLayout = (CardLayout) userProcessContainer.getLayout();
        ProjectViewJPanel pvjp = new ProjectViewJPanel(userProcessContainer, userAccount, organization, enterprise);
    ...
    private void btnViewChartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewChartActionPerformed
        // TODO add your handling code here:
        CardLayout  cardLayout = (CardLayout) userProcessContainer.getLayout();
        ViewIssuesStatisticsJPanel cjp = new ViewIssuesStatisticsJPanel(userProcessContainer, system,userAccount);
        userProcessContainer.add("cjp",cjp);
        cardLayout.next(userProcessContainer);
    ...
    private void btnViewResolvedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewResolvedActionPerformed
        // TODO add your handling code here:
        CardLayout  cardLayout = (CardLayout) userProcessContainer.getLayout();
        ViewResolvedIssuesStatisticsJPanel vrisjp = new ViewResolvedIssuesStatisticsJPanel(userProcessContainer, system, userAccount);
