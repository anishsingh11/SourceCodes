 ...
 * @author mansiagrawal
 */
public class VolunteerHomeJPanel extends javax.swing.JPanel {
    ...
    public VolunteerHomeJPanel(JPanel mainContainer, EcoSystem system, DB4OUtil dB4OUtil, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
        ...
        VolunteerWorkAreaJPanel vwajp = new VolunteerWorkAreaJPanel(userProcessContainer, system, userAccount, organization, enterprise);
        userProcessContainer.add("VolunteerWorkAreaJPanel", vwajp);
