...
public class ManageNGOJPanel extends javax.swing.JPanel {
     ...
     */
     ...
     EcoSystem system;
    public ManageNGOJPanel(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnDeleteNGO.setText("Delete NGO");
        ...
        lblName.setText("Name of the NGO:");
        ...
        if (tblNGO.getColumnModel().getColumnCount() > 0) {
            ...
            tblNGO.getColumnModel().getColumn(1).setResizable(false);
            tblNGO.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    private void btnAddNGOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNGOActionPerformed
        ...
        if(!name.equals("")){
                   ...
                   for(State s: c.getStateList()){
                       if(s.equals(state)){
                          for(City cy: s.getCityList()){
                              if(cy.equals(city)){
                                  cy.getEnterpriseDirectory().createAndAddEnterprise(name, Enterprise.EnterpriseType.NGO);
                              }
                          }
                       }
                   }   
            ...
            populateTable();
            txtFldName.setText("");
            JOptionPane.showMessageDialog(null, "NGO added successfully", "Info", JOptionPane.INFORMATION_MESSAGE);
        }else{
    ...
    private void btnDeleteNGOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteNGOActionPerformed
        ...
        if(selectedRow >= 0){
            int dialogResult = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete the NGO?","Warning", JOptionPane.YES_NO_OPTION);
...
//                State s = (State) tblNGO.getValueAt(selectedRow, 1);
                ...
                city.getEnterpriseDirectory().deleteEnterprise((NGOEnterprise)e);
                populateTable();
                JOptionPane.showMessageDialog(null, "NGO deleted successfully","Warning", JOptionPane.WARNING_MESSAGE);
